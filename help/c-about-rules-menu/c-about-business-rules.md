...
Åtgärden definierar vad som händer när utlösarvillkoret uppfylls. Du kan till exempel ställa in banderollen så att ett givet resultat visas eller flyttas till position 1. Regeltabellen visar sammanfattningsinformation om regeln. Du kan klicka på ett regelnamn för att öppna det och visa ytterligare information.
...
Ni godkänner affärsreglerna och gör dem tillgängliga så att de kan köras i er aktiva miljö. För närvarande kan du bara överföra *alla* regler live. Du kan dock ändra en regels status så att du har kontroll över vilka regler som körs och inte körs i den aktiva miljön.
...
Du kan använda [!DNL Visual Rule Builder] eller [!DNL Advanced Rule Builder] lägga till affärsregler som skräddarsyr kundens sökupplevelse.
...
1. Gör något av följande:
   ...
   * Klicka på **[!UICONTROL Rules]** > **[!UICONTROL Business Rules]** på produktmenyn. På [!DNL Business Rules] sidan klickar du på **[!UICONTROL Add New Rule]**.

   * Klicka på på produktmenyn **[!UICONTROL Simulator]**. På **[!UICONTROL Simulator for Today]** sidan klickar du **[!UICONTROL Add New Rule]** till höger om **[!UICONTROL Options]** listrutan.

      Om **[!UICONTROL Add New Rule]** alternativet inte visas på sidan klickar du på i **[!UICONTROL Options]** listrutan **[!UICONTROL Simulate Staged]**.

      ![](assets/Simulator.png)

1. Skriv det nya namnet på affärsregeln i textfältet **[!UICONTROL Name]** .

   Klicka inte **[!UICONTROL Save Rule]** än.
1. (Valfritt) Om du hanterar ett stort antal affärsregler kan du tagga affärsregler med specifika etiketter. I **[!UICONTROL Tags]** fältet anger du en eller flera taggetiketter, använder kommatecken, tabb eller Enter som avgränsare.
   ...
   * Ett svar där en anpassad kombination av utlösare anges. Det innebär att du kombinerar enskilda utlösare eller&quot;villkor&quot; med `AND` operatorer och `OR` operatorer.
      ...
      >[!NOTE]
      >
      >Om du kombinerar `AND` operatorer med `OR` operatorer i en anpassad uppsättning med affärsregler måste du ange parenteser så att utlösarna utvärderas i rätt ordning.
   ...
   **Åtgärdsalternativ**
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Gäller endast Adobe Dynamic Media Classic-mallar. </p> <p>Gör att du kan ändra standardparametrarna som används i banderollmallen. </p> <p>Se tabellen med alternativ i Lägga till en banderoll med Adobe Dynamic Media Classic <a scope="local" href="../c-about-design-menu/c-about-banners.md#task_AD1E0C00A9E04B1FA819EB93288786B3" type="reference" format="dita"> </a>. </p> <p>Se även <a href="../c-about-design-menu/c-about-banners.md#task_C3E782477FBF428ABEA220751781ACA9" type="task" format="dita" scope="local"> Redigera en banderoll med Adobe Dynamic Media Classic </a>. </p> </td> 
      </tr> 
      <tr> 
   ...
   * När panelen har tagits bort **[!UICONTROL Triggers]** - Högerklicka på ett sökresultat eller en sökaspekt i området för presentationsmallen på sidan Business Rule Builder och klicka sedan på **[!UICONTROL Add "result present" trigger]**.

      Klicka på&quot;X&quot; till vänster om en utlösare på utlösarpanelen för att ta bort den från listan med utlösare.

   * När panelen inte längre visas **[!UICONTROL Actions]** - Högerklicka på ett sökresultat i området för presentationsmallar på sidan Business Rule Builder. Klicka **[!UICONTROL Add Result]**, **[!UICONTROL Remove Result]**, **[!UICONTROL Push to bottom]** eller **[!UICONTROL Push to #`<n>`]** (där `<n>` är en siffra).


1. (Valfritt) Gör något av följande i någon av panelerna Business Rule Builder ( [!DNL Triggers], [!DNL Actions]eller [!DNL Schedule]):

   * Högerklicka på en banderoll i området för presentationsmallen på sidan Business Rule Builder och klicka sedan på **[!UICONTROL Select different banner]**. På **[!UICONTROL Pick Banner]** sidan klickar du på **[!UICONTROL Pick this banner]** under miniatyrbilden för banderollen för att lägga till den i presentationsmallen. Det är bara banners som matchar storleken och området på den ursprungliga bannern i presentationsmallen som du kan välja mellan.

      Åtgärden Lägg till banderoll läggs till på [!DNL Actions] panelen.

   * Högerklicka på en Adobe Dynamic Media Classic-mallbanderoll vars parametrar du vill ändra i området för presentationsmallen på [!DNL Business Rule Builder] sidan och klicka sedan på **[!UICONTROL Add banner commands]**. Ange de parameteralternativ som du vill använda i dialogrutan [!DNL Change Parameters] .
      ...
      Parameterändringarna läggs till på [!DNL Actions] panelen.
   ...
   * Högerklicka på en banderoll som du vill ta bort från sidan i området för presentationsmallen på sidan i Business Rule Builder. Klicka sedan på **[!UICONTROL Remove banner]**. Borttagningsbanderollåtgärden läggs till på åtgärdspanelen.

1. (Valfritt) Gör något av följande på **[!UICONTROL Schedule]** panelen:

   * Klicka **[!UICONTROL Run Indefinitely]** om du vill att regeln ska köras när dess associerade utlösare uppfylls. Det här alternativet är standard.
   * Klicka **[!UICONTROL Fixed Schedule]** och ange sedan startdatum och -tid samt slutdatum och sluttid för regeln som ska köras när dess associerade utlösare uppfylls.

1. Klicka på **[!UICONTROL Save Rule]**.
1. (Valfritt) Gör något av följande på [!DNL Business Rules] sidan:
...
1. Gör något av följande på [!DNL Business Rules] sidan:

   * Klicka under [!DNL Name] kolumnen på namnet på en affärsregel som du vill ändra.
   ...
   * I listrutan klickar du på **[!UICONTROL Edit in advanced mode]** eller bredvid ett namn på en affärsregel som du vill redigera **[!UICONTROL Edit in visual mode]**.

1. Skriv det nya namnet på affärsregeln i textfältet [!DNL Name] .

   Klicka inte **[!UICONTROL Save Rule]** än. 1. Ange de utlösare och åtgärder som du vill använda på [!DNL Business Rule Builder] sidan.
...
1. (Valfritt) Gör något av följande på en **[!UICONTROL Business Rule Builder]** panel ( [!DNL Triggers], [!DNL Actions]eller [!DNL Schedule]i:

   * Högerklicka på en banderoll i området för presentationsmallen på [!DNL Business Rule Builder] sidan och klicka sedan på **[!UICONTROL Select different banner]**. Klicka på [!DNL Pick Banner page]**[!UICONTROL Pick this banner]** under miniatyrbilden för banderollen för att lägga till den i presentationsmallen. Det är bara banners som matchar storleken och området på den ursprungliga bannern i presentationsmallen som du kan välja mellan.
   ...
   * Högerklicka på en banderoll som du vill ta bort från sidan i området för [!DNL Business Rule Builder] presentationsmallen och klicka sedan på **[!UICONTROL Remove banner]**. Åtgärden Ta bort banderoll läggs till på [!DNL Actions] panelen.

1. (Valfritt) Gör något av följande på [!DNL Schedule] panelen:
...
1. Klicka på **[!UICONTROL Save Rule]**.
   ...
   Sidan stängs och du kommer tillbaka till [!DNL Business Rule Builder]**[!UICONTROL Business Rule]** sidan. Reglerna visas i tabellen. Klicka på kolumnrubriken om du vill sortera reglerna efter redigeringsdatum. **[!UICONTROL Modified]** 1. (Valfritt) Gör något av följande:
...
1. Klicka på **[!UICONTROL Rules]** > **[!UICONTROL Business Rules]** på produktmenyn.
1. Klicka på i listrutan bredvid ett namn på en affärsregel som du vill kopiera på **[!UICONTROL Business Rules]** sidan **[!UICONTROL Copy rule]**.
...
## Godkänna affärsregler {#task_BD569D18BF664272B8692294C162E2C1}
...
1. På [!DNL Business Rules] sidan kan du använda kolumnrubriken status i kolumnen [!DNL Status] i affärsregeltabellen för att sortera reglerna som har statusen **[!UICONTROL WIP]** eller **[!UICONTROL suspended]**.

   Använd kryssrutans kolumnrubrik till vänster i tabellen för att kontrollera alla regler som visas på sidan eller endast de som har statusen **[!UICONTROL WIP]** eller **[!UICONTROL suspended]**. 1. Klicka på menyraden uppe på sidan **[!UICONTROL Approve]**.
1. Klicka på i **[!UICONTROL Confirm Action]** dialogrutan **[!UICONTROL OK]**.
...
## Pausa affärsregler {#task_364E1FFB905141C08E306C8F1794A20E}
...
1. Klicka på **[!UICONTROL Rule]** > **[!UICONTROL Business Rules]** på produktmenyn.
1. På [!DNL Business Rules] sidan, med hjälp av statuskolumnen i affärsregeltabellen, i kolumnen längst till vänster i tabellen, kontrollerar du reglerna som har statusen **[!UICONTROL WIP]**, eller **[!UICONTROL approved]**.
1. Klicka på menyraden uppe på sidan **[!UICONTROL Suspend]**.
1. Klicka på i **[!UICONTROL Confirm Action]** dialogrutan **[!UICONTROL OK]**.
1. (Valfritt) Gör något av följande:
...
1. Klicka på **[!UICONTROL Rule]** > **[!UICONTROL Business Rules]** på produktmenyn.
1. På [!DNL Business Rules] sidan, med hjälp av statuskolumnen i affärsregeltabellen, i kolumnen längst till vänster i tabellen, kontrollerar du reglerna som har statusen **[!UICONTROL suspended]**.
1. Klicka på menyraden uppe på sidan **[!UICONTROL Resume]**.
1. Klicka på i [!DNL Confirm Action] dialogrutan **[!UICONTROL OK]**.
1. (Valfritt) Gör något av följande:
...
Affärsreglerna körs i den ordning de har definierats. Ju högre ordningsnummer en regel har, desto senare körs den i processen, vilket innebär att tidigare regler utlöses. Du ändrar ordning på reglerna genom att ange ett nytt nummer i kolumnen Ordning i tabellen på [!DNL Business Rules] sidan. Du kan också använda dra-och-släpp-regler för att ändra deras körningsordning.

**Ändra ordningen som affärsreglerna körs i**

1. Klicka på **[!UICONTROL Rule]** > **[!UICONTROL Business Rules]** på produktmenyn.
1. Gör något av följande på [!DNL Business Rules] sidan i tabellen:

   * Klicka på kolumnrubriken om du vill sortera reglerna i stigande eller fallande ordning. **[!UICONTROL Order]**
   * I **[!UICONTROL Order]** kolumnen, i textfältet till vänster om namnet på en affärsregel, skriver du det ordningsnummer som du vill att regeln ska köras på.
...
## Raderar affärsregler {#task_AE37B42412044541BCC6D46CF8793DFF}
...
1. Klicka på i den [!DNL Bulk Actions] nedrullningsbara listan **[!UICONTROL Delete]**.
1. Klicka på i [!DNL Confirm Action] dialogrutan **[!UICONTROL OK]**.
1. (Valfritt) Gör något av följande:
