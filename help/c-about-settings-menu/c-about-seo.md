...
När du sparar eller förhandsgranskar dina SEO-inställningar genereras små segment av sökmallar (transportmallar) som du kan inkludera i dina andra sökmallar med `<search-include>` malltaggen. Du kan t.ex. inkludera fältet Sökresultatsidors titel i en annan mall med följande:

```
<search-include file="seo/seo_search_title.tpl" />
```

De nio möjliga värdena för `file` attributet för `<search-include>` taggen för SEO-fält är följande:
...
Först använder du `<search-include>` enligt beskrivningen ovan för att inkludera önskade fält i en XML-sökmall i ett `<general>` element.
...
I presentationsmallen kan du sedan använda `<guided-general-field>` -taggar för att infoga namngivna fält där du behöver det, som i följande exempel:
...
Observera att attributet används för att ange `gsname` i det här fallet standardsökningen.
...
Se även [Mallar](../c-about-design-menu/c-about-templates.md#concept_06EB481B14864E18A8AE2BCD1D6EF0B5).
...
Se även [Konfigurera en sökresultatordslista](../c-about-settings-menu/c-about-seo.md#task_A459A3734EC04042BA52C81184251DD4).
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL SEO]** > **[!UICONTROL Search Result Pages]**.
1. På [!DNL SEO Browse Pages Word List] sidan, i respektive [!DNL Title], [!DNL Description]och [!DNL Keywords] grupper, anger du önskade alternativ.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Visa en lista med de ord som du vill lägga till i sökresultatsidans titel, bläddringssidans titel eller objektets informationssidtitel. </p> <p>Klicka på <b>Redigera</b> för att lägga till ord i listan. </p> <p>Du kan lägga till ett ord eller en fras per rad. När du är klar klickar du på <b>Spara ändringar</b>och stänger sedan sidan för att återgå till SEO-huvudsidan. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Ta bort dessa ord och fraser (förutom från inkluderade fältvärden) </p> </td> 
      <td colname="col2"> <p>Visa en lista med de ord som du vill ta bort från sökresultatsidans titel, bläddringssidans titel eller objektets informationssidtitel. </p> <p>Klicka på <b>Redigera</b> för att lägga till ord i listan Ta bort. </p> <p>Du kan lägga till ett ord eller en fras per rad. När du är klar klickar du på <b>Spara ändringar</b>och stänger sedan sidan för att återgå till SEO-huvudsidan. </p> </td> 
      </tr> 
    </tbody> 
    </table>

1. (Valfritt) Klicka på **Förhandsgranska provutdata** om du vill förhandsvisa de resulterande värdena för de SEO-fält som du anger.

   Se [Förhandsgranska SEO-metataggar som du har konfigurerat](../c-about-settings-menu/c-about-seo.md#task_3F97949E193C4F92A104AD117FE49621).
...
1. (Valfritt) Gör något av följande på [!DNL SEO Search Results Word List] sidan:
...
## Konfigurera en ordlista för bläddringssidor {#task_D7A1D765A92A4D6C94E672B3A86ECB5A}
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL SEO]** > **[!UICONTROL Browse Pages]**.
1. På [!DNL SEO Browse Pages Word List] sidan, i respektive [!DNL Title], [!DNL Description]och [!DNL Keywords] grupper, anger du önskade alternativ.
...
1. (Valfritt) Återskapa indexet för den mellanlagrade platsen om du vill förhandsgranska resultatet.
   ...
   Se [Konfigurera ett inkrementellt index för en mellanlagrad webbplats](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Valfritt) Gör något av följande på [!DNL SEO Browse Pages Word List] sidan:
...
## Konfigurera en artikeldetaljordlista {#task_761538C519B34164BE189F13C39B2495}
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL SEO]** > **[!UICONTROL Item Detail Pages]**.
1. På [!DNL SEO Item Detail Word List] sidan, i respektive [!DNL Title], [!DNL Description]och [!DNL Keywords] grupper, anger du önskade alternativ.
...
1. (Valfritt) Återskapa indexet för den mellanlagrade platsen om du vill förhandsgranska resultatet.
   ...
   Se [Konfigurera ett inkrementellt index för en mellanlagrad webbplats](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Valfritt) Gör något av följande på [!DNL SEO Item Detail Word List] sidan:
...
## Förhandsgranska SEO-metataggar som du har konfigurerat {#task_3F97949E193C4F92A104AD117FE49621}
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL SEO]** > **[!UICONTROL Search Result Pages]**.
1. På SEO-sidan klickar du på **Förhandsgranska provutdata**.
1. Skriv den frågeterm som du vill söka efter på [!DNL SEO Preview] sidan i [!DNL Enter sample query] fältet.
1. Klicka på **Sök**.
