...
## Konfigurera dina kontoinställningar {#task_80A38D0C8E4F453395BD67B81E4B45D9}
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Account Settings]**.
1. Ange önskade alternativ på [!DNL Account Settings] sidan.
...
Du kan konfigurera integreringen av webbplatssökning/-försäljning med Adobe CQ5.
...
1. Hämta ditt medlems-ID och konto-ID genom att göra följande:
   ...
   * Kopiera medlems-ID och konto-ID i URL-sökvägen.
      ...
      Om URL-sökvägen till ditt konto till exempel är `https://searchandpromote.mycompany.com/px/home/?sp_id=00123a4b-sp1234a5b6`, blir medlems-ID:t `00123a4b` och konto-ID:t `sp1234a5b6`.

1. I Adobe CQ5 använder du fliken Molntjänster för att skapa din webbplatssöknings-/marknadsföringskonfiguration.

   Använd det kopierade medlems-ID:t och konto-ID:t för respektive inställningar.

## Konfigurera inställningar för marknadsföring {#task_7AC7B9F5D9F44E10AB5BC0B8CB31C37A}
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Merchandising Preferences]**.
1. Ange önskade alternativ på [!DNL Merchandising Preferences] sidan.
...
## Konfigurera åtkomst till ditt Adobe Dynamic Media Classic-konto {#task_CEFF88C2033D41D0B2FE86C435EDAC6D}
...
**Konfigurera åtkomst till ditt Adobe Dynamic Media Classic-konto**

1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Scene7 Configuration]**.
1. Ange önskade alternativ på [!DNL Scene7 Configuration] sidan.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>Obligatoriskt. Identifierar den e-postadress som används för inloggning och kommunikation med Dynamic Media Classic. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Lösenord </p> </td> 
      <td colname="col2"> <p>Obligatoriskt. Ditt inloggningslösenord för Dynamic Media Classic. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Aktiverad </p> </td> 
      <td colname="col2"> <p>Aktiverar alla Dynamic Media Classic-kontroller i webbplatssökningar/-marknadsföring. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Testa </p> </td> 
      <td colname="col2"> <p>Verifierar att namnet, e-postadressen och lösenordsinformationen för din Dynamic Media Classic-region är korrekta. </p> </td> 
      </tr> 
    </tbody> 
    </table>

1. (Valfritt) Klicka för **[!UICONTROL Test]** att verifiera att namnet, e-postadressen och lösenordsinformationen för den dynamiska Media Classic-regionen är korrekta.
1. Klicka på **[!UICONTROL Save Changes]**.

## Konfigurera omdirigeraren för Adobe Analytics {#task_2C9DE333FD7246E4A460FC0F55204160}

Om du använder [!DNL Adobe Analytics] för att spåra webbplatsbesökare kan du använda [!DNL Adobe Analytics Redirector] vid webbplatssökning/försäljning för att spåra alla HTTP-omdirigeringar med [!DNL Adobe Analytics].

**Konfigurera omdirigeraren för Adobe Analytics**

1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Adobe Analytics Redirector]**.
1. Ange önskade alternativ på [!DNL Adobe Analytics Redirector] sidan.
   ...
   <table> 
    ...
    <tbody> 
      <tr> 
      <td colname="col1"> <p>Aktivera omdirigeringsfunktionen i Adobe Analytics </p> </td> 
      ...
      <li id="li_67A93D17C3A14874928C6DC4FF2D4784"> I <span class="wintitle"> </span> grupprutan Alternativ väljer du en rapportsserie i respektive listruta. </li> 
      <li id="li_5AAB004AC58441DBB0F813BDE30EFFD4"> Klicka på <span class="uicontrol"> Generera kod </span>. </li> 
      <li id="li_E80368993F4D4DD69E37509FF4348B36"> Klicka på fliken <span class="wintitle"> Core Javascript File på </span> sidan <span class="uicontrol"> Code Manager </span>. </li> 
      <li id="li_991BDCDDA41A445F85CEEAAE9A46A304"> I <span class="wintitle"> Config Section </span>hittar du följande rader: <p> <code> s.trackingServer="yourcompany.122.2o7.net" </code> </p> <p>Spårningsserverns namn är i det här fallet <span class="codeph"> "dincompany.122.2o7.net" </span> </p> </li> 
      </ol> </p> </td> 
      </tr> 
      <tr> 
      ...
      <li id="li_AAC47EAA04144A67BDCB5C7B8D8098E9"> Leta reda på ID:t i kolumnen <span class="wintitle"> Report Suite Id </span> i tabellen. </li> 
      </ol> </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Egna parametrar </p> </td> 
      <td colname="col2"> <p>Gör att du kan lägga till anpassade parametrar i omdirigerings-URL:en för Adobe Analytics. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Ange skiftläget för alla anpassade värden till </p> </td> 
      <td colname="col2"> <p>Gör att du kan standardisera med det hölje som används för alla anpassade parametervärden som du har angett ovan. Adobe Analytics är skiftlägeskänsligt, så det finns en anledning att förena värdefallet. </p> </td> 
      </tr> 
    </tbody> 
    </table>
...
1. (Valfritt) Gör något av följande på [!DNL Adobe Analytics Redirector] sidan:
...
## Konfigurera rotfiler {#task_5F175C8743FB49A2A003813CBF7C56BF}

Hantera rotfiler i webbplatsens rotmapp.

**Så här konfigurerar du rotfiler**

1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Root Files]**.
1. På [!DNL Root Files] sidan bläddrar du till de rotfiler som du vill överföra.
...
1. (Valfritt) Återskapa indexet för den mellanlagrade platsen om du vill förhandsgranska resultatet.
   ...
   Se [Konfigurera ett inkrementellt index för en mellanlagrad webbplats](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0).
1. (Valfritt) Gör något av följande på [!DNL Root Files] sidan:
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Transfer Ownership]**.
1. På [!DNL Transfer Ownership] sidan klickar du på den användare som du vill ska bli ägare till ditt konto.
1. Klicka på **[!UICONTROL Transfer]**.

## Ta bort ett konto {#task_975178D5B9444BF8B52D72B897A49C32}
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Remove Account]**.
1. (Valfritt) Ange en orsak till att kontot har tagits bort i [!DNL Reason for Removal] fältet.
1. Klicka på **[!UICONTROL Remove Account]**.

## Ta bort dig själv från ett konto {#task_C56F5AB87B664BAAAC2FD2F15003E73F}
...
1. På produktmenyn klickar du på **[!UICONTROL Settings]** > **[!UICONTROL Account Options]** > **[!UICONTROL Remove Yourself]**.
