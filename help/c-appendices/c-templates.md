...
<td colname="col2"> <p>Visar innehåll när resultat hittas. Eller visar ingen resultat-HTML när resultat inte hittas. </p> <p> <code class="syntax html"> &lt;guided-if-results-found&nbsp;gsname="products"&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Taggen <span class="codeph"> &lt;guided-result-description&gt; </span> ger värdet för det beskrivande transportmallsfältet som anges med <span class="codeph"> &lt;description&gt;- </span> transporttaggen. </p> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Returnerar ansiktets visningsetikett. </p> <p>Om funktionen använder taggen <span class="codeph"> &lt;display-name&gt; </span> i transportmallen blir innehållet i den taggen etikett. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Den här villkorstaggen är true när det bara finns ett facet-värde. Använd taggen för att ändra visningen av ansiktet när det inte går att förfina resultatet. </p> <p> <code class="syntax html"> &lt;guided-facet&nbsp;name="category"&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-facet-values&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-facet-single&gt; 
      &lt;/guided-facet&gt; </code> </p> <p>Du kan också använda det här villkoret utanför kontexten för ett namngivet <span class="codeph"> guidat </span> facet-block genom att referera till en specifik aspekt direkt med <span class="codeph"> Gsname- </span> attributet. </p> <p> <code class="syntax html"> &lt;guided-if-facet-single&nbsp;gsname="category"&gt; 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ger dig den aktuella sökvägen som används. Vanligtvis används den för att skapa en länk som lägger till en ny parameter i den befintliga sökningen. Som standard är sökvägen URL escape. Du kan ange vilket läge du vill använda för escape-parametern. </p> <p>Exempel: </p> <p> <code class="syntax html"> &lt;a&nbsp;href="&lt;guided-current-path&nbsp;/&gt;&amp;lang=fr"&gt; 
      French&nbsp;Version </code> </p> <p>I det här exemplet använder en regel för sökbearbetning språk för att välja den franska versionen. </p> <p>Den aktuella sökvägen har alltid minst en frågeparameter. Om det inte finns några andra frågeparametrar ställs den in på <span class="codeph"> </span> q=* så att det blir enklare att lägga till fler parametrar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> Grundsökväg </span> </p> </td> 
   <td colname="col2"> <p> Om du vill skapa en länk med bassökvägen använder du <span class="codeph"> / </span> i början av <span class="codeph"> href </span> och lägger till parametrar. </p> <p> <code class="syntax html"> &lt;a&nbsp;href="/"&gt;All&nbsp;Products&lt;/a&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Här kan du hämta det befintliga värdet för en frågeparameter som finns på URL:en. Om parametern inte finns returnerar den här taggen en tom sträng. Om du inte anger ett escape-alternativ som den returnerade strängen automatiskt HTML-escape-konverterare kan du ange antingen HTML eller URL-escape. </p> <p>Exempel: </p> <p> 
    ...
    ger&amp;nbsp;you&amp;nbsp;the&amp;nbsp;value&amp;nbsp;byxor
    
    &amp;lt;guided-query-param&amp;namp;namn bsp;gsname=&quot;lang&quot;&amp;nbsp;/&amp;gt;
    ger&amp;nbsp;du&amp;nbsp;the&amp;nbsp;value&amp;nbsp;en
    
    &amp;lt;guided-query-param&amp;nbsp;gsname=&quot;test&quot;&amp;nbamp sp;/&amp;gt;
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Med guidad sökning avses ett frågenummer som används i kontrollen för vägbeskrivningar. <span class="codeph"> Med hjälp av guided-query-param-name </span> kan du definiera parametrar som en del av en länk i presentationsmallen där guidad sökning anger rätt frågenummer för dig. Spelet <span class="codeph"> innehåller </span> "x" och den guidade sökningen ersätter det med rätt nummer. Förskjutningsvärdet kan vara 0 - 15, där 0 anger att nästa tillgängliga frågenummer används. En siffra anger att du vill lägga till 1 i den och så vidare. </p> <p>I kombination med <span class="codeph"> guidad-aktuell-sökväg </span>kan du skapa en egen mini facet-länk eller tillåta en extra detaljnivå. </p> <p>Exempel: </p> <p> <code class="syntax html"> &lt;a&nbsp;href="&lt;guided-current-path 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Gör att du kan ta med andra mallfiler. Den här funktionen innebär att du kan skapa flera mallar med hjälp av undermallar som moduler. </p> <p>I följande exempel ingår <span class="filepath"> breadcrumbs- </span> och <span class="filepath"> facets- </span> filer: </p> <p> <code class="syntax html"> &lt;guided-include&nbsp;gsfile='breadcrumbs.tmpl'&nbsp;/&gt; 
      &lt;guided-include&nbsp;gsfile='facets.tmpl'&nbsp;/&gt; </code> </p> <p>Dynamiska inkluderingar stöds inte. Filen gsfile <span class="codeph"> </span> kan med andra ord inte vara en variabel. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Taggar omgivande sökmallstaggar som ger sammanfattningsdata baserat på resultatuppsättningen. Vanligtvis innehåller dessa taggar söktaggar för totalt antal resultat, lägre resultat och högsta resultat. Du kan definiera ett valfritt antal ytterligare globala fält som du vill använda med <span class="codeph"> taggen general-field </span> , som i följande exempel: </p> <p> <code class="syntax html"> &lt;general&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Med <span class="codeph"> avgränsarattributet kan </span> du ändra avgränsaren som används när du matar ut data för sökningsvisningsfält för listor. Standardvärdet är ett komma. </p> <p>I allmänhet bör avgränsaren som du använder vara något som inte visas på ett enkelt sätt i fältinnehållet. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> &lt;förslag&gt;&lt;/förslag&gt; </span> </p> </td> 
   <td colname="col2"> <p> Omsluta dina Menade du-förslag med taggar så att guidad sökning kan identifiera vilka XML-noder som innehåller förslag. </p> <p>Se <a href="../c-about-linguistics-menu/c-about-did-you-mean.md#concept_7D4F3C29EF184B538B8AE2ECAE0CDC5E" type="concept" format="dita" scope="local"> Om menade</a>du. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> &lt;förslag&gt;&lt;/förslag&gt; </span> </p> </td> 
   <td colname="col2"> <p>Radbryt varje "Menade"-förslag med taggar, som i följande exempel: </p> <code class="syntax html"> &lt;search-if-suggestions&gt; 
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&lt;/search-suggestions&gt; 
     &nbsp;&nbsp;&lt;/suggestions&gt; 
     &lt;/search-if-suggestions&gt; </code> <p>Se <a href="../c-about-linguistics-menu/c-about-did-you-mean.md#concept_7D4F3C29EF184B538B8AE2ECAE0CDC5E" type="concept" format="dita" scope="local"> Om menade</a>du. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Returnerar poängen för det aktuella resultatet, vilket är ett tal mellan 0 och 100. Om du har definierat ett rangordningsfält under <span class="uicontrol"> Alternativ </span> &gt; <span class="uicontrol"> Metadata </span> &gt; <span class="uicontrol"> Definitioner </span>kan du visa den dynamiska sidrankningen genom att ange attributet rank till dynamic ( <span class="codeph"> &lt;search-score rank="dynamic"&gt; </span>). Du kan visa den statiska sidrankningen genom att ange attributet rank till statisk ( <span class="codeph"> &lt;search-score rank="static"&gt; </span>). Du kan använda det valfria precisionsattributet för att ange antalet decimaler som ska visas. Standardvärdet är 0, vilket visar heltalsmusiken). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;sökstorlek&gt; </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Returnerar URL:en för det aktuella resultatet. </p> <p>Använd det valfria <span class="codeph"> length-attributet </span> för att begränsa längden på de strängar som visas, med ett standardvärde på obegränsat antal tecken. </p> <p>Kodningsattributet är <span class="codeph"> </span> valfritt och kan koda utdatatecken med HTML-kodning, JavaScript-kodning, Perl-kodning eller ingen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-url-path-query length="XX"&gt; </span> </p> </td> 
   <td colname="col2"> <p>Returnerar sökvägen och frågedelarna inklusive frågetecknet för det aktuella resultatets URL. </p> <p>Använd det valfria <span class="codeph"> length-attributet </span> för att begränsa längden på de strängar som visas, med ett standardvärde på obegränsat antal tecken. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>10 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-context length="XX" encoding="html/javascript/json/perl/url/none" &gt; </span> </p> </td> 
   <td colname="col2"> <p>Returnerar nästa rad med kontext för söktermen. Relevanta termer visas i fet stil. Anropa den här taggen upprepade gånger för att visa mer än en kontextrad för det aktuella resultatet. </p> <p>Använd det valfria <span class="codeph"> length-attributet </span> för att begränsa längden på de strängar som visas, med standardvärdet 80 tecken. Attributet <span class="codeph"> length </span> ignoreras om den här taggen omges av antingen <span class="codeph"> &lt;search-if-context&gt; </span> eller <span class="codeph"> &lt;search-if-any-context&gt;- </span> koduppsättningar som innehåller ett length-attribut. </p> <p>Kodningsattributet är <span class="codeph"> </span> valfritt och kan koda utdatatecken med HTML-kodning (standard), Javascript-kodning, Perl-kodning eller ingen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>11 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field name="field-name" length="XX" none="text" date-format="date-format-string" gmt="yes/no" language="0/2/language-id" encoding="html/javascript/json/perl/url/none" quotes="yes/no" commas="yes/no" units="miles/Miles avgränsare"="|"&gt; </span> </p> </td> 
   <td colname="col2"> <p>Den här avancerade taggen visar innehållet i metadatafältet (url, title, desc, keys, target, body, alt, date, charset och language eller fält som definieras under <span class="uicontrol"> Alternativ </span> &gt; <span class="uicontrol"> Metadata </span> &gt; Definitioner) som anges i <span class="codeph"> name- </span> attributet för det aktuella resultatet. Exempel: </p> <p> <span class="codeph"> &lt;search-display-field name="title" length="70" none="no title"&gt; </span> </p> <p>Visar sidans rubrik för ett sökresultat. Om det valfria <span class="codeph"> inget </span> attribut anges visas dess värde på resultatsidan endast om det inte finns något innehåll kopplat till fältet. </p> <p>Attributen <span class="codeph"> date-format </span>, <span class="codeph"> gmt </span> och <span class="codeph"> language </span> är bara relevanta om innehållstypen för det angivna fältet är <span class="codeph"> date </span>. </p> <p>Attributet <span class="codeph"> date-format </span> har en datumformatsträng i UNIX-format som <span class="codeph"> %A, %B %d, %Y </span> (för måndag den 25 juli 2016). <span class="codeph"> gmt </span> har som standard <span class="codeph"> yes </span> och styr om tidsdelen i datumsträngen ska skrivas ut i GMT ( <span class="codeph"> yes </span>) eller kontots tidszon ( <span class="codeph"> no </span>). </p> <p>Se <a href="../c-appendices/c-templates.md#section_4BBDBBEF2B96414497617CD4B52D96E4" type="section" format="dita" scope="local"> Datumformatsträngar</a>. </p> <p>Språkattributet <span class="codeph"> </span> styr språk- och språkkonventionerna för utdatadatumsträngen. <span class="codeph"> 0 </span> (standard) betyder "Använd kontospråk". <span class="codeph"> 2 </span> betyder"Använd dokumentspråk". Språkvärdet <span class="codeph"> </span><span class="codeph"> 1 </span> är reserverat för framtida bruk). Alla andra <span class="codeph"> språkvärden </span> tolkas som en specifik språkidentifierare, t.ex. <span class="codeph"> en_US </span> betyder "Engelska (USA)". </p> <p>Se <a href="../c-appendices/c-templates.md#section_0490DECC00E34691ADE5A9ED90A6D911" type="section" format="dita" scope="local"> Språkidentifierare</a>. </p> <p>Attributet för valfri <span class="codeph"> längd </span> används för att begränsa längden på de strängar som visas, med standardvärdet 80 tecken. </p> <p>Det valfria <span class="codeph"> kodningsattributet </span> styr om utdata är HTML-kodade, JavaScript-kodade, Perl-kodade, URL-kodade eller inte kodade, för utdata på resultatsidan. Standardvärdet för <span class="codeph"> kodning </span> är <span class="codeph"> html </span>. Normalt behöver du inte ange kodningsattributet. </p> <p>Attributet för valfria <span class="codeph"> citattecken </span> styr om enskilda utdataobjekt omges av dubbla citattecken (eller enkla citattecken, om <span class="codeph"> encoding=perl </span>). Standardvärdet för <span class="codeph"> citattecken </span> är <span class="codeph"> no </span>. </p> <p>De valfria <span class="codeph"> kommatecknen </span> styr om enskilda objekts utdata avgränsas med kommatecken. Standardvärdet för <span class="codeph"> kommatecken </span> är <span class="codeph"> yes </span>. Attributet för <span class="codeph"> kommatecken </span> ignoreras för fält som inte är av listtyp. </p> <p>Attributet för valfria <span class="codeph"> enheter </span> styr de avståndsenheter som används i ett utdatafält för närhetssökning. Standardvärdet för <span class="codeph"> enheter </span> bestäms av inställningen "Standardenheter" i fältet för platstyp som är associerat med det angivna fältet för närhetssökning. </p> <p>Se <a href="../c-appendices/r-about-proximity-search.md#reference_45AC6BB50609431ABD31DA46EE65360D" type="reference" format="dita" scope="local"> Om närhetssökning</a>. </p> <p>Det valfria <span class="codeph"> avgränsarattributet </span> definierar det enskilda tecknet, eller avgränsaren, som infogas mellan värdena för utdata för listtypsfält. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>12 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Visar information om placeringen av det aktuella resultatet, t.ex. eventuella resultatbaserade åtgärder som påverkade resultatets position. </p> <p>Utdataformatet för den här taggen är JSON som i följande exempel: </p> <p> <code> { 
    ...
    <!--<p> Results added to the results set by way of <codeph>rbta</codeph> have a "naturalPosition" value of -1. </p>--> <p>Kodningsattributet <span class="codeph"> är </span> valfritt. standardvärdet är <span class="codeph"> html </span>. </p> <p> <p>Obs!  Den här taggen har bara utdata om <span class="codeph"> sp_trace=1 </span> har angetts med huvudsökfrågeparametrarna. </p> </p> <p>Se rad 48 i tabellen som finns i CGI-parametrar <a href="../c-appendices/c-cgiparameters.md#reference_582E85C3886740C98FE88CA9DF7918E8" format="dita" scope="local"></a>för backend-sökning. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dessa taggar inkluderar HTML mellan dem om nästa anrop till <span class="codeph"> &lt;search-body&gt; </span> returnerar (eller inte returnerar) text från dokumentets brödtext. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   ...
   <td colname="col2"> <p>Dessa taggar innehåller HTML mellan dem om nästa anrop till <span class="codeph"> &lt;search-context&gt; </span> returnerar (eller inte returnerar) en icke-tom kontextsträng. Attributet length åsidosätter attributet length för alla inneslutna <span class="codeph"> &lt;search-context&gt;- </span> -taggar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   ...
   <td colname="col2"> <p>Dessa taggar innehåller HTML mellan dem om det finns (eller inte är) en kontextsträng som är associerad med resultatet. Attributet length åsidosätter attributet length för alla inneslutna <span class="codeph"> &lt;search-context&gt;- </span> -taggar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   ...
   <td colname="col2"> <p>Dessa taggar inkluderar HTML mellan dem om poängen för det aktuella resultatet är (eller inte är) mellan XX och YY. Användbart om du vill lägga till punkter eller bilder för att visa hur relevant resultatet är. Om du har definierat ett fält av typen rankning under <span class="uicontrol"> Alternativ </span> &gt; <span class="uicontrol"> Metadata </span> &gt; <span class="uicontrol"> Definitioner </span>kan du kontrollera den dynamiska sidrankningen genom att ange attributet rankning till dynamiskt ( <span class="codeph"> &lt;search-if-score rank="dynamic" lower=XX upper=YY&gt; </span>). Du kan kontrollera den statiska sidans rankning genom att ange attributet rank till statisk ( <span class="codeph"> &lt;search-if-score rank="static" lower=XX upper=YY&gt; </span>). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
...
## Länkmärkord för resultatloopar {#section_C5FAEF520E9E42ADAD1F90651922AA02}
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colname="col01"> <p>1 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-link target="frame-name" hbx-enable="yes/no" hbx-line-name="field-name" hbx-line-none="text" hbx-line-length="XX" &gt; ... &lt;/search-link&gt; </span> </p> </td> 
...
Observera slutligen att det `<search-if-even>` alltid är samma som `<search-if-alt>` för sökfältsvärden eftersom fältvärden inte växlas.

## Listtaggar för fältvärde {#section_D3298B5F976447DBA0032B883DCC91B1}

Följande avancerade taggar genererar fältvärden och relaterade data från hela uppsättningen sökresultat. Dessa taggar ger bara utdata för fält som anges av `sp-sfvl-field` CGI-parametrarna i sökfrågan.
...
Följande avancerade taggar räknar upp och returnerar fältvärden och relaterade data från hela uppsättningen sökresultat med hjälp av en slingkonstruktion. Dessa taggar ger bara utdata för fält som anges av `sp-sfvl-field` CGI-parametrarna i sökfrågan.
...
Föreslå innehåller ett användarvänligt&quot;Menade du?&quot; för att föreslå alternativa söktermer. Om en användare har felstavat en sökterm, till exempel, kan Föreslå hjälpa användaren att hitta resultat genom att föreslå en korrekt stavning. Systemet kan även föreslå relaterade nyckelord som kan hjälpa en användare att identifiera resultaten. När du skapar förslag använder tjänsten Föreslå två ordlistor: en baserad på kontospråket (anges under **[!UICONTROL Indexing]** > **[!UICONTROL Words and Languages]** > **[!UICONTROL Language]**) och den andra som är unikt byggd utifrån nyckelorden i kontoindexet.
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colname="col01"> <p>1 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;sök-om-förslag&gt; ... &lt;/search-if-ideas&gt; </span> </p> </td> 
   <td colname="col2"> <p>Omge dessa taggar med malltaggar för "Föreslå", till exempel <span class="codeph"> &lt;sök-förslag&gt; </span>, <span class="codeph"> &lt;sök-förslag-länk&gt; </span>och så vidare. Om sökningen genererar förslag genereras och bearbetas allt mellan den öppna och den avslutande taggen. Om sökningen inte genererar några förslag kommer inget av det kapslade innehållet att skapas. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;sökförslag&gt; ... &lt;/search-ideas&gt; </span> </p> </td> 
   <td colname="col2"> <p>Med den här taggen genereras slingan "Föreslå", som innehåller en lista med föreslagna söktermer (till exempel "Föreslå", "Tänkt" och "Avsikt" för en fråga som ursprungligen angavs som "Avsikt"). När sökmotorn genererar en lista med termer upprepas alla kapslade HTML- och/eller malltaggar upp till fem gånger, vilket är det maximala antalet förslag. Använd attributet count för att ange antalet genererade förslag (mellan 0 och 5). </p> <p>Taggen <span class="codeph"> &lt;search-ideas&gt; </span> kan visas flera gånger på sidan för att upprepa listan med förslag. Flera förslag sorteras efter antalet resultat som varje resultat ger. </p> <p>Kapsla taggen <span class="codeph"> &lt;search-recommendations&gt; </span> mellan öppna och stäng <span class="codeph"> &lt;search-if-recommendations&gt;- </span> taggar. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;sökförslagslänk&gt; ... &lt;/search-draft-link&gt; </span> </p> </td> 
   <td colname="col2"> <p>Med det här märkordet skapas en länk till den ursprungliga sökfrågan med det valda föreslagna söktermen i stället för det ursprungliga. Taggen godkänner och skriver helt enkelt ut alla HTML-attribut som class, target och style. Taggen kan även acceptera ett URL-attribut, vars värde används som bas-URL för den genererade länken. Taggarna kan bara visas inuti <span class="codeph"> &lt;search-ideas&gt;- </span> slingan. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-draft-text/&gt; </span> </p> </td> 
   <td colname="col2"> <p>Med den här taggen skrivs den aktuella föreslagna frågetermen ut (t.ex. "avser" för en fråga som ursprungligen angavs som "avser"). Taggen har inga attribut och kan bara visas inuti <span class="codeph"> &lt;search-ideas&gt;- </span> slingan. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;sök-om-inte-förslag&gt; ... &lt;/search-if-not-ideas&gt; </span> </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if[-not]-first-draft&gt; ... &lt;/search-if[-not]-first-draft&gt; </span> </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if[-not]-last-draft&gt; ... &lt;/search-if[-not]-last-draft&gt; </span> </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>8 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-draft-index&gt; </span> </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-draft-total&gt; </span> </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>10 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-draft-result-count&gt; </span> </p> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-query-number="XX" encoding="html/javascript/json/perl/url/none"&gt; </span> </p> </td> 
   <td colname="col2"> <p>Frågan som besökaren angav. Det avancerade valfria attributet "query-number" kontrollerar vilken numrerad frågesträng som skapas av den här taggen. Till exempel <span class="codeph"> matar </span> &lt;search-query-number=1&gt; ut innehållet i <span class="codeph"> cgi-parametern </span> sp_q_1. Om "query-number" inte anges, eller om query-number är "0", kommer huvudfrågan ( <span class="codeph"> sp_q </span>) att returneras. Det valfria attributet "encoding" kontrollerar om utdata är HTML-kodade, JavaScript-kodade, Perl-kodade, URL-kodade eller inte kodade, för utdata på resultatsidan. Standardvärdet för "encoding" är "html". Normalt behöver du inte ange kodningsattributet. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;söksumma&gt; </span> </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>11 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;söktid&gt; </span> </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>14 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;sökformulär&gt; ...&lt;/search-form&gt; </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Infogar en formulärindatatagg som anger frågesträngen. Det avancerade valfria attributet "query-number" kontrollerar vilken numrerad fråga som används för formulärindatataggen. Exempelvis <span class="codeph"> &lt;search-input-query-number=1&gt; </span> skickar en formulärindatatagg för <span class="codeph"> sp_q_1- </span> frågan. Om "query-number" inte anges, eller om "query-number" är "0", infogas en indatatagg för <span class="codeph"> sp_q- </span> huvudfrågan. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>18 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Infogar utdata från en av sökmallstaggarna i andra HTML- eller malltaggar på resultatsidan. <span class="codeph"> &lt;search-lt&gt; </span> infogar ett tecken som är mindre än. Om du använder <span class="codeph"> &lt;search-lt&gt; </span> och <span class="codeph"> &lt;search-gt&gt; </span> kan du kringgå definitionen av en tagg så att du kan använda sökmallstaggar som attributvärden. När mallen återges som svar på en sökning ersätter ett mindre än-tecken (&lt;) <span class="codeph"> &lt;search-lt&gt;- </span> -taggen. Exempelvis <span class="codeph"> motsvarar </span> &lt;search-link&gt; <span class="codeph"> &lt;search-lt&gt;a href="&lt;search-url&gt;"&lt;search-gt&gt; </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>20 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-gt&gt; </span> </p> </td> 
   <td colname="col2"> <p>Infogar utdata från en av sökmallstaggarna i andra HTML- eller malltaggar på resultatsidan. <span class="codeph"> &lt;search-gt&gt; </span> infogar ett tecken som är större än. Om du använder <span class="codeph"> &lt;search-lt&gt; </span> och <span class="codeph"> &lt;search-gt&gt; </span> kan du kringgå definitionen av en tagg så att du kan använda andra malltaggar som attributvärden. När mallen återges som svar på en sökning ersätter ett större än-tecken (&gt;) <span class="codeph"> &lt;search-gt&gt;- </span> -taggen. Exempelvis <span class="codeph"> motsvarar </span> &lt;search-link&gt; <span class="codeph"> &lt;search-lt&gt;a href="&lt;search-url&gt;"&lt;search-gt&gt; </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>21 </p> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dessa taggar inkluderar HTML om <span class="codeph"> CGI-parametern sp_advanced=1 har angetts för sökfrågan </span> . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
...
Taggar som gör att du kan styra standardläget för val av kryssrutor, alternativknappar och listrutor i en `<form>` sökmall.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;sök-markera&gt; ... &lt;/search-select&gt; </span> </p> <p> <span class="codeph"> &lt;sökalternativ&gt; ... &lt;/search-option&gt; </span> </p> </td> 
   <td colname="col2"> <p>Listrutor i en <span class="codeph"> &lt;form&gt;- </span> tagg startas med en <span class="codeph"> &lt;select&gt;- </span> tagg och avslutas med en <span class="codeph"> &lt;/select&gt;- </span> tagg. Namnet på <span class="codeph"> den associerade CGI-parametern visas i </span> &lt;select&gt;- <span class="codeph"> </span> taggen. Efter taggen <span class="codeph"> &lt;select&gt; </span> finns en lista med <span class="codeph"> &lt;option&gt;- </span> taggar som anger vilka värden som ska visas i listrutan. </p> <p>Med taggarna <span class="codeph"> &lt;search-select&gt; </span>, <span class="codeph"> &lt;/search-select&gt; </span>, <span class="codeph"> &lt;search-option&gt; </span>och <span class="codeph"> &lt;/search-option&gt; </span> får du liknande funktionalitet som <span class="codeph"> &lt;search-input&gt;- </span> taggen. Det vill säga att det ord som <span class="codeph"> markeras </span> läggs till automatiskt i slutet av den <span class="codeph"> &lt;option&gt;- </span> tagg som skickas till webbläsaren om <span class="codeph"> namnet </span> i <span class="codeph"> &lt;search-select&gt;- </span> taggen listas som en CGI-parameter och om <span class="codeph"> värdet </span> <span class="codeph"> </span> <span class="codeph"> </span> för den CGI-parametern listas som värdet¥ i en speciell &lt;search-option&gt;-tagg. På så sätt kan du automatiskt göra standardvalet för listrutor i sökresultatet till samma som för den aktuella frågan. </p> <p>En vanlig listruta ser till exempel ut så här: </p> <p> <code class="syntax html"> &lt;select&nbsp;name="sp_x"&nbsp;size=1&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dessa avancerade taggar skapar en ankarlänk runt HTML-koden mellan dem. När du klickar på den här ankarpunkten visas en resultatsida som är sorterad i det angivna fältet. Attributet för valfritt <span class="codeph"> antal </span> anger antalet resultat som ska visas på resultatsidan. Om <span class="codeph"> antal </span> utelämnas används det antal som används på den aktuella sidan. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* `search-date` och `search-display-field`.
   ...
   Se Strängtaggar [för](../c-appendices/c-templates.md#section_80D68334E8D04A33937A6E58ABAAA320)resultatslingor.
...
## Ange HTTP-huvudet av innehållstyp {#section_AEED823E9938448A9EDB2F286D9CFD90}
...
Attributen `content` och `charset` är valfria. Taggen ska visas så tidigt som möjligt i mallen. Vi rekommenderar också att den visas före antingen `<search-html-meta-charset>` eller `<search-xml-decl>`eftersom den påverkar beteendet för dessa taggar.

Om du inte anger `content` attributet blir standardvärdet `MIME-type` det värde som anges i **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**. Om du anger ett `content` attribut används det som standardattribut `content` för `<search-html-meta-charset>` -taggen.

Om du inte anger attributet `charset` skrivs inget `charset` värde till `content-type` huvudet.

Om du anger `charset="1"` är det faktiska värdet för `charset-name` värdet på `sp_f` CGI-parametern. Om ingen `sp_f` CGI-parameter skickas tillsammans med sökningen `charset-name` läses det faktiska värdet för från dina kontoinställningar. Du kan visa eller ändra teckenuppsättningen som är kopplad till ditt konto under **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**.
...
Du kan välja ett specifikt namn på teckenuppsättningen genom att ange det som `charset` värde, till exempel `charset="iso-8859-1"` eller `charset="Shift-JIS"`.

Om du anger ett `charset` attribut används det som standardattribut `charset` för `<search-html-meta-charset>` - och `<search-xml-decl>` -taggarna samt som utdata till `content-type` rubriken.
...
Om du inte anger innehållsattributet blir det verkliga värdet för `MIME-type` standardvärdet ett av två värden. Om taggen `<search-content-type-header>` anger ett `content` attribut används det värdet. I annat fall är det värde som används den uppsättning som finns på fliken **[!UICONTROL Templates]** > **[!UICONTROL Settings]** > **[!UICONTROL Content Type]** .

Om du inte anger `charset` attributet blir det faktiska standardvärdet `charset-name` ett av två värden. Om taggen `<search-content-type-header>` anger ett `charset` attribut används det värdet. Annars läses det faktiska värdet för `charset-name` från dina kontoinställningar. Du kan visa eller ändra teckenuppsättningen som är kopplad till ditt konto under **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**.

Se [Konfigurera din personliga användarinformation](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6).

Om du anger `charset="1"` är det faktiska värdet för `charset-name` värdet på `sp_f` CGI-parametern. Om ingen `sp_f` CGI-parameter skickas tillsammans med sökningen `charset-name` är det faktiska värdet för antingen det värde som angetts i `<search-content-type-header>` -taggen, om den angetts, eller det värde som angetts i kontoinställningarna.

Du kan ange ett specifikt namn på teckenuppsättningen, som i `charset="charset-name"`. For example, `charset="iso-8859-1"` or `charset="Shift-JIS"`.

Taggen är valfri `<search-html-meta-charset>` . Om du tar bort den får webbläsaren standardvärdena för `content-type`, vilket är följande: `content="text/html; charset=ISO-8859-1"`. Du kan också välja att ersätta `<search-html-meta-charset>` taggen med en egen `http-equiv` tagg.
...
Attributet `charset` är valfritt. Det här märkordet måste finnas högst upp i mallen, men efter eventuella `<search-content-type-header>` -märkord. Det här märkordet ger följande märkord i XML-dokumentet som genereras från mallen:

`<?xml version="1.0" encoding="charset-name" standalone="yes" ?>`

Om du inte anger `charset`används det faktiska standardvärdet `charset-name` som ett av två värden. Om `<search-content-type-header>` ett `charset` attribut anges används det värdet. Annars läses det faktiska värdet för `charset-name` från dina kontoinställningar. Du kan visa eller ändra teckenuppsättningen som är kopplad till ditt konto under **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**.

Se [Konfigurera din personliga användarinformation](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6).

Om du anger `charset="1"` är det faktiska värdet för `charset-name` värdet på `sp_f` CGI-parametern. Om ingen `sp_f` CGI-parameter skickas tillsammans med sökningen `charset-name` är det faktiska värdet för antingen det värde som anges i `<search-content-type-header>` -taggen om den angavs, eller det värde som anges i kontoinställningarna.

Du kan ange ett specifikt namn på teckenuppsättningen, som i `charset="charset-name"`om du vill. Exempel, `charset="iso-8859-1" or charset="Shift-JIS"`.

Du kan välja att ersätta `<search-xml-decl>` taggen med en egen `?xml` tagg.

## Inkludera en sökmall i en annan {#section_7D1FCD3D9E2340C291E354C9720E8BC0}

Om du vill ta med en sökmall i en annan använder du taggen och anger filattributet till namnet på den mallfil som du vill ta med som i följande exempel: `<search-include>`

`<search-include file="seo/seo_search_title.tpl" />`

SEO-sökmallssegment finns i undermappen och vanliga sökmallar finns i `seo/` `templates/` undermappen. Det är bara tpl-filer som är relevanta att inkludera i det här sammanhanget.
...
Om du vill ställa in sökformulären så att de använder en viss transportmall (annan än standardtransportmallen) använder du `sp_t` frågeparametern. Anta till exempel att du har en sökmall som heter&quot;radering&quot; för den markerade säljardelen på din webbplats. Du använder det vanliga HTML-sökformuläret med följande extra formulärkod:
